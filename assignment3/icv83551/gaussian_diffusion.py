...
class GaussianDiffusion(nn.Module):
    ...
    def predict_start_from_noise(self, x_t, t, noise):
        ...
        ####################################################################
        recip_sqrt_ab = extract(self.sqrt_alphas_cumprod,t,x_t.shape)
        sqrt_recipm1_ab = extract(self.sqrt_one_minus_alphas_cumprod,t,x_t.shape)
        x_start = (x_t -sqrt_recipm1_ab*noise) / recip_sqrt_ab
        ####################################################################
        return x_start
    ...
    def predict_noise_from_start(self, x_t, t, x_start):
        ...
        pred_noise = (x_t - sqrt_ab * x_start) / sqrt_1mab 
        ####################################################################
        return pred_noise
